...
public class ModScreenHandlers {
    ...
    public static final ScreenHandlerType<CustomAnvilScreenHandler> CUSTOM_ANVIL_SCREEN_HANDLER =
            Registry.register(Registries.SCREEN_HANDLER, Identifier.of(EnchantingDecisions.MOD_ID, "custom_anvil_block"), new ScreenHandlerType<>(CustomAnvilScreenHandler::new, FeatureSet.empty()));
