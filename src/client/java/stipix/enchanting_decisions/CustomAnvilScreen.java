...
public class CustomAnvilScreen extends ForgingScreen<CustomAnvilScreenHandler> {
    ...
    public CustomAnvilScreen(CustomAnvilScreenHandler handler, PlayerInventory inventory, Text title) {
